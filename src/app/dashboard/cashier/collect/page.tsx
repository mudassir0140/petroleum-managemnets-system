...
export default function CollectPaymentPage() {
  const { activeShift, shiftTransactions, recordTransaction } = useCashierShift();
  ...
  return (
    <div className="space-y-6">
          ...
          <form className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2 lg:grid-cols-5" onSubmit={handleSubmit}>
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                placeholder="e.g. Oil filter sale"
                className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
              />
            </div>
            <div>
            ...
            <div className="sm:col-span-2 lg:col-span-5">
              <button
                type="submit"
                className="w-full rounded-lg bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-700 dark:bg-amber-500 dark:text-slate-950 dark:hover:bg-amber-400 sm:w-auto"
              >
                Log Transaction
              </button>
            </div>
      ...
      <SectionCard title="This shift's transactions">
