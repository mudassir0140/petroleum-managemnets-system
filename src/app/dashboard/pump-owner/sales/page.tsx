...
import { ownerPump } from "@/lib/dashboard/data/pump-owner-portal";
...
export default function PumpOwnerSalesPage() {
  const pump = ownerPump();

  if (!pump) {
    return (
      <div className="space-y-6">
        <PageHeader title="My Sales" description="Fuel sales breakdown for your pump." />
