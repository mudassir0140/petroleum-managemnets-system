...
import { managerStockMovements, managerTanks } from "@/lib/dashboard/data/pump-manager-portal";
import { FUEL_TYPE_LABELS } from "@/lib/dashboard/data/stations";
import { formatLiters } from "@/lib/dashboard/format";

export default function PumpManagerFuelStockPage() {
  const tanks = managerTanks();
  const movements = managerStockMovements();

  return (
    <div className="space-y-6">
      <PageHeader title="Fuel Stock" description="Petrol & diesel tank levels and recent stock movements at your assigned pump." />
